...
- **Web-Player:** Ein separater, vom Betreiber gewählter Host liefert nur Pairing, Player-API und optional den APK-Download. Host-Routing sperrt Studio-Routen auf diesem Host.
