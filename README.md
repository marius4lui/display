...
Authentik kann als OIDC-Login verwendet werden; bestehende Benutzer werden dabei über ihre E-Mail zugeordnet. Konfiguration und das Abschalten des lokalen Passwort-Logins sind unter [Deployment](docs/DEPLOYMENT.md#authentik-über-oidc) beschrieben.
